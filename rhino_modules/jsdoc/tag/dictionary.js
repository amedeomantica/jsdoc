...
function _TagDefinition(title, etc) {
    ...
    for (var p in etc) {
        if (Object.prototype.hasOwnProperty.call(etc, p)) {
            this[p] = etc[p];
        }
    }
}
...
var dictionary = {
    ...
    lookUp: function(title) {
        ...
        if ( Object.prototype.hasOwnProperty.call(_definitions, title) ) {
           return _definitions[title];
        }
    ...
    normalise: function(title) {
        ...
        if ( Object.prototype.hasOwnProperty.call(_synonyms, canonicalName) ) {
